    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell Kitty Item" action="kittyItemsMarketSellMarketItem" method="post" fields="signer itemID price">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget> 
          <text-widget field="price" label="Price" placeholder="5.0"></text-widget>           
        </action-card>
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"
          description="Buy Kitty Item" action="kittyItemsMarketBuyMarketItem" method="post"
        ...
        <action-card title="DAY 5: Burn Kitty Item" 
          description="Burn Kitty Item" action="kittyItemsBurnKittyItem"
